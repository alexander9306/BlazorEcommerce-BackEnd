    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 8, 5, 11, 10, 33, 804, DateTimeKind.Local).AddTicks(1715), "Celulares nuevos y usados.", true, "Celulares", new DateTime(2020, 8, 5, 11, 10, 33, 809, DateTimeKind.Local).AddTicks(3097) });

            migrationBuilder.InsertData(
                table: "Categorias",
                columns: new[] { "Id", "CreatedAt", "Descripcion", "Estado", "Nombre", "UpdatedAt" },
                values: new object[] { 2, new DateTime(2020, 8, 5, 11, 10, 33, 809, DateTimeKind.Local).AddTicks(3581), "Tenemos computadoras de ultima generacion.", true, "Computadoras", new DateTime(2020, 8, 5, 11, 10, 33, 809, DateTimeKind.Local).AddTicks(3598) });

            migrationBuilder.InsertData(
                table: "Marcas",
                columns: new[] { "Id", "CreatedAt", "Nombre" },
                values: new object[] { 1, new DateTime(2020, 8, 5, 11, 10, 33, 811, DateTimeKind.Local).AddTicks(9190), "Dell" });

            migrationBuilder.InsertData(
                table: "Marcas",
                columns: new[] { "Id", "CreatedAt", "Nombre" },
                values: new object[] { 2, new DateTime(2020, 8, 5, 11, 10, 33, 811, DateTimeKind.Local).AddTicks(9882), "Acer" });

            migrationBuilder.InsertData(
                table: "Marcas",
                columns: new[] { "Id", "CreatedAt", "Nombre" },
                values: new object[] { 3, new DateTime(2020, 8, 5, 11, 10, 33, 811, DateTimeKind.Local).AddTicks(9902), "BLU" });

            migrationBuilder.InsertData(
                table: "Marcas",
                columns: new[] { "Id", "CreatedAt", "Nombre" },
                values: new object[] { 4, new DateTime(2020, 8, 5, 11, 10, 33, 811, DateTimeKind.Local).AddTicks(9905), "Asus" });

            migrationBuilder.InsertData(
                table: "Marcas",
                columns: new[] { "Id", "CreatedAt", "Nombre" },
                values: new object[] { 5, new DateTime(2020, 8, 5, 11, 10, 33, 811, DateTimeKind.Local).AddTicks(9908), "Google" });

            migrationBuilder.InsertData(
                table: "Marcas",
                columns: new[] { "Id", "CreatedAt", "Nombre" },
                values: new object[] { 6, new DateTime(2020, 8, 5, 11, 10, 33, 811, DateTimeKind.Local).AddTicks(9910), "Huawei" });

            migrationBuilder.InsertData(
                table: "Marcas",
                columns: new[] { "Id", "CreatedAt", "Nombre" },
                values: new object[] { 7, new DateTime(2020, 8, 5, 11, 10, 33, 811, DateTimeKind.Local).AddTicks(9913), "Apple" });

            migrationBuilder.InsertData(
                table: "Marcas",
                columns: new[] { "Id", "CreatedAt", "Nombre" },
                values: new object[] { 8, new DateTime(2020, 8, 5, 11, 10, 33, 811, DateTimeKind.Local).AddTicks(9915), "LG" });

            migrationBuilder.InsertData(
                table: "Marcas",
                columns: new[] { "Id", "CreatedAt", "Nombre" },
                values: new object[] { 9, new DateTime(2020, 8, 5, 11, 10, 33, 811, DateTimeKind.Local).AddTicks(9917), "Samsung" });

            migrationBuilder.InsertData(
                table: "Marcas",
                columns: new[] { "Id", "CreatedAt", "Nombre" },
                values: new object[] { 10, new DateTime(2020, 8, 5, 11, 10, 33, 811, DateTimeKind.Local).AddTicks(9919), "HP" });
